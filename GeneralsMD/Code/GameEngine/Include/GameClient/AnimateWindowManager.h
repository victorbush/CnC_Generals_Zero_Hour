...
//-----------------------------------------------------------------------------
class AnimateWindow_ : public MemoryPoolObject
{
	MEMORY_POOL_GLUE_WITH_USERLOOKUP_CREATE(AnimateWindow_, "AnimateWindow")
public:
	AnimateWindow_( void );
	//~AnimateWindow( void );
...
//-----------------------------------------------------------------------------
typedef	std::list<AnimateWindow_ *>	AnimateWindowList;
...
// INLINING ///////////////////////////////////////////////////////////////////
//-----------------------------------------------------------------------------
	inline ICoord2D			AnimateWindow_::getStartPos( void )	{ return m_startPos; };
	inline ICoord2D			AnimateWindow_::getCurPos( void )		{ return m_curPos; };
	inline ICoord2D			AnimateWindow_::getEndPos( void )		{ return m_endPos; };
	inline ICoord2D			AnimateWindow_::getRestPos( void )		{ return m_restPos; };
	inline GameWindow  * AnimateWindow_::getGameWindow( void ){ return m_win; };
	inline AnimTypes		AnimateWindow_::getAnimType( void )	{ return m_animType; };
	inline UnsignedInt	AnimateWindow_::getDelay( void )			{ return m_delay; };
	inline Coord2D			AnimateWindow_::getVel( void )				{ return m_vel; };
	inline UnsignedInt	AnimateWindow_::getStartTime( void )	{ return m_startTime; };
	inline UnsignedInt	AnimateWindow_::getEndTime( void )		{ return m_endTime; };

	inline void	AnimateWindow_::setStartPos( ICoord2D startPos)		{ m_startPos = startPos; };
	inline void	AnimateWindow_::setCurPos( ICoord2D curPos)				{ m_curPos = curPos; };
	inline void	AnimateWindow_::setEndPos( ICoord2D endPos)				{ m_endPos = endPos; };
	inline void	AnimateWindow_::setRestPos( ICoord2D restPos)			{ m_restPos = restPos; };
	inline void	AnimateWindow_::setGameWindow( GameWindow *win)		{ m_win = win; };
	inline void	AnimateWindow_::setAnimType( AnimTypes animType)		{ m_animType = animType; };
	inline void	AnimateWindow_::setDelay( UnsignedInt delay)				{ m_delay = delay; };
	inline void	AnimateWindow_::setVel( Coord2D vel)								{ m_vel = vel; };
	inline void	AnimateWindow_::setStartTime( UnsignedInt t )			{ m_startTime = t; }
	inline void	AnimateWindow_::setEndTime( UnsignedInt t )				{ m_endTime = t; }

	inline void	AnimateWindow_::setFinished( Bool finished)				{ m_isFinished = finished; };
	inline Bool	AnimateWindow_::isFinished( void )									{ return m_isFinished; };
	inline void	AnimateWindow_::setNeedsToFinish( Bool needsToFinish)		{ m_needsToFinish = needsToFinish; };
	inline Bool	AnimateWindow_::needsToFinish( void )							{ return m_needsToFinish; };
