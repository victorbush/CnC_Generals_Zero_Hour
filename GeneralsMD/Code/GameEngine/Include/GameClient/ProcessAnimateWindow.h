...
public:
	...
	virtual void initAnimateWindow(AnimateWindow_ *animWin ) = 0;
	virtual void initReverseAnimateWindow(AnimateWindow_ *animWin, UnsignedInt maxDelay = 0 ) = 0;
	virtual Bool updateAnimateWindow(AnimateWindow_ *animWin ) = 0;
	virtual Bool reverseAnimateWindow(AnimateWindow_ *animWin ) = 0;
...
public:
	...
	virtual void initAnimateWindow(AnimateWindow_ *animWin );
	virtual void initReverseAnimateWindow(AnimateWindow_ *animWin, UnsignedInt maxDelay = 0 );
	virtual Bool updateAnimateWindow(AnimateWindow_ *animWin );
	virtual Bool reverseAnimateWindow(AnimateWindow_ *animWin );
private:
