...
enum AttitudeType { ATTITUDE_SLEEP = -2, ATTITUDE_PASSIVE=-1, ATTITUDE_NORMAL=0, ATTITUDE_ALERT=1, ATTITUDE_AGGRESSIVE=2, ATTITUDE_INVALID=3 };		///< AI "attitude" behavior modifiers
