...
//-----------------------------------------------------------------------------
void ProcessAnimateWindowSlideFromRight::initReverseAnimateWindow(AnimateWindow_ *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
...
//-----------------------------------------------------------------------------
void ProcessAnimateWindowSlideFromRight::initAnimateWindow(AnimateWindow_ *animWin )
{
...
//-----------------------------------------------------------------------------
Bool ProcessAnimateWindowSlideFromRight::updateAnimateWindow(AnimateWindow_ *animWin )
{
...
Bool ProcessAnimateWindowSlideFromRight::reverseAnimateWindow(AnimateWindow_ *animWin )
{
...
void ProcessAnimateWindowSlideFromLeft::initReverseAnimateWindow(AnimateWindow_ *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into initAnimateWindow as a NULL Pointer... bad bad bad!"));
...
void ProcessAnimateWindowSlideFromLeft::initAnimateWindow(AnimateWindow_ *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
Bool ProcessAnimateWindowSlideFromLeft::updateAnimateWindow(AnimateWindow_ *animWin )
{
...
Bool ProcessAnimateWindowSlideFromLeft::reverseAnimateWindow(AnimateWindow_ *animWin )
{
...
void ProcessAnimateWindowSlideFromTop::initReverseAnimateWindow(AnimateWindow_ *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into initAnimateWindow as a NULL Pointer... bad bad bad!"));
...
void ProcessAnimateWindowSlideFromTop::initAnimateWindow(AnimateWindow_ *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
Bool ProcessAnimateWindowSlideFromTop::updateAnimateWindow(AnimateWindow_ *animWin )
{
...
Bool ProcessAnimateWindowSlideFromTop::reverseAnimateWindow(AnimateWindow_ *animWin )
{
...
void ProcessAnimateWindowSlideFromBottom::initReverseAnimateWindow(AnimateWindow_ *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into initAnimateWindow as a NULL Pointer... bad bad bad!"));
...
void ProcessAnimateWindowSlideFromBottom::initAnimateWindow(AnimateWindow_ *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
Bool ProcessAnimateWindowSlideFromBottom::updateAnimateWindow(AnimateWindow_ *animWin )
{
...
Bool ProcessAnimateWindowSlideFromBottom::reverseAnimateWindow(AnimateWindow_ *animWin )
{
...
void ProcessAnimateWindowSlideFromBottomTimed::initReverseAnimateWindow(AnimateWindow_ *animWin, UnsignedInt maxDelay )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
void ProcessAnimateWindowSlideFromBottomTimed::initAnimateWindow(AnimateWindow_ *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
Bool ProcessAnimateWindowSlideFromBottomTimed::updateAnimateWindow(AnimateWindow_ *animWin )
{
...
Bool ProcessAnimateWindowSlideFromBottomTimed::reverseAnimateWindow(AnimateWindow_ *animWin )
{
...
//-----------------------------------------------------------------------------
void ProcessAnimateWindowSpiral::initReverseAnimateWindow(AnimateWindow_ *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into initAnimateWindow as a NULL Pointer... bad bad bad!"));
...
//-----------------------------------------------------------------------------
void ProcessAnimateWindowSpiral::initAnimateWindow(AnimateWindow_ *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
//-----------------------------------------------------------------------------
Bool ProcessAnimateWindowSpiral::updateAnimateWindow(AnimateWindow_ *animWin )
{
...
//-----------------------------------------------------------------------------
Bool ProcessAnimateWindowSpiral::reverseAnimateWindow(AnimateWindow_ *animWin )
{
...
void ProcessAnimateWindowSlideFromTopFast::initReverseAnimateWindow(AnimateWindow_ *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into initAnimateWindow as a NULL Pointer... bad bad bad!"));
...
void ProcessAnimateWindowSlideFromTopFast::initAnimateWindow(AnimateWindow_ *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D curPos = {0,0};
...
Bool ProcessAnimateWindowSlideFromTopFast::updateAnimateWindow(AnimateWindow_ *animWin )
{
...
Bool ProcessAnimateWindowSlideFromTopFast::reverseAnimateWindow(AnimateWindow_ *animWin )
{
...
//-----------------------------------------------------------------------------
void ProcessAnimateWindowSlideFromRightFast::initReverseAnimateWindow(AnimateWindow_ *animWin, UnsignedInt maxDelay )
{
	if(!animWin)
	{
		DEBUG_ASSERTCRASH( animWin, ("animWin was passed into initAnimateWindow as a NULL Pointer... bad bad bad!"));
...
//-----------------------------------------------------------------------------
void ProcessAnimateWindowSlideFromRightFast::initAnimateWindow(AnimateWindow_ *animWin )
{
	ICoord2D restPos = {0,0};
	ICoord2D startPos = {0,0};
	ICoord2D size = {0,0};
...
//-----------------------------------------------------------------------------
Bool ProcessAnimateWindowSlideFromRightFast::updateAnimateWindow(AnimateWindow_ *animWin )
{
...
Bool ProcessAnimateWindowSlideFromRightFast::reverseAnimateWindow(AnimateWindow_ *animWin )
{
