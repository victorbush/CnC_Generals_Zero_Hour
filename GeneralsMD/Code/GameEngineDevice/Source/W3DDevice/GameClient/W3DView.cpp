...
void W3DView::setHeight(Int height)
{
	...
	m_3DCamera->Set_View_Plane(-1, (Real)height / (Real)TheDisplay->getHeight() * DEG_TO_RADF(38.55f));
}
...
void W3DView::setWidth(Int width)
{
	...
	m_3DCamera->Set_View_Plane(-1, (Real)m_height / (Real)TheDisplay->getHeight() * DEG_TO_RADF(38.55f));
}
...
#if defined(RTS_DEBUG) || defined(RTS_INTERNAL)
	// VMB : Disabled this for widescreen hack
